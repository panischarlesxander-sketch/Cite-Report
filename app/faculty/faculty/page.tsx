...
export default function FacultySignaturePage() {
  const { user } = useAuth();
  ...
  return (
    <FacultyLayout title="E-Signature">
      <div className="max-w-3xl mx-auto">
        <div className="card-soft overflow-hidden">
          <div className="bg-gradient-to-r from-green-600 to-green-600 px-6 py-5 flex items-center gap-4">
            <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center border border-white/30">
              <CheckCircle2 className="w-5 h-5 text-white" />
            </div>
            <div>
              <h2 className="text-lg font-bold text-white">E-Signature Profile</h2>
              <p className="text-green-100 text-xs mt-0.5">Your signature is attached to your submitted WFH accomplishment reports.</p>
            </div>
          </div>
          ...
          <div className="p-8 flex flex-col items-center">
            {loading ? (
              ...
              <div className="mb-8 relative group w-full max-w-sm">
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-green-500/10 to-transparent h-[200%] animate-[scan_3s_ease-in-out_infinite] opacity-50 pointer-events-none mix-blend-overlay" />
                </div>
            ...
            {isUploading && (
              <div className="mt-8 flex flex-col items-center gap-3 text-green-600 font-semibold animate-pulse w-full max-w-sm">
                <div className="relative w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="absolute inset-y-0 left-0 bg-green-500 rounded-full w-full animate-[shimmer_1.5s_infinite]" />
                </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  This signature is automatically applied to your WFH accomplishment reports.
                </p>
              </div>
            </div>
          </div>
